...
function activate({ subscriptions }) {
    ...
    (0, status_bar_1.statusBarIndicator)(myStatusBarItem, "busy", {
        title: "Busy file status: mark as busy",
        command: markAsIdleCommand,
    });
    vscode.window.showInformationMessage("Hello world");
    subscriptions.push(vscode.commands.registerCommand(markAsBusyCommand, () => {
        (0, status_bar_1.statusBarIndicator)(myStatusBarItem, "busy", {
            title: "Busy file status: mark as busy",
            command: markAsIdleCommand,
        });
    }), vscode.commands.registerCommand(markAsIdleCommand, () => {
        (0, status_bar_1.statusBarIndicator)(myStatusBarItem, "idle", {
            title: "Busy file status: mark as busy",
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.statusBarIndicator = void 0;
const vscode = __importStar(__webpack_require__(1));
function statusBarIndicator(myStatusBarItem, status, command) {
    if (status === "busy") {
